...
export function ButtonMain({props}:any) {
  return (
    <Link href={"/"} className='w-72'>
      <button className='h-[61px] md:w-60 w-72 bg-[#212121] text-white border-2 border-gray-500 items-center flex justify-center font-semibold gap-2 text-lg'><CgShoppingCart size={"28"} />{props}</button>
    </Link>
  )
...
export default function Hero() {
  return (
    <div className='w-full container grow mx-auto max-w-sm md:px-0 px-4 md:max-w-7xl py-9'>
      <div className='flex justify-between'>
        <div className='flex flex-col md:pt-10 gap-9'>
          ...
          <div className='font-bold md:text-6xl md:pr-5 text-5xl leading-tight lg:text-green-300 xl:text-red-200'>An Industrial Take on StreetWear</div>
